...
export default function EditPostForm({post}: EditPostFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-6 max-w-3xl">
      <div>
        <label htmlFor="title" className="block text-sm font-medium text-neutral-600 dark:text-neutral-300">
          Titulo
        </label>
        <input
          id="title"
      ...
      <div>
        <label htmlFor="slug" className="block text-sm font-medium text-neutral-600 dark:text-neutral-300">
          Slug
        </label>
        <input
          id="slug"
      ...
      <div>
        <label htmlFor="excerpt" className="block text-sm font-medium text-neutral-600 dark:text-neutral-300">
          Resumo
        </label>
        <textarea
          id="excerpt"
      ...
      <div>
        <label className="block text-sm font-medium text-neutral-600 dark:text-neutral-300">Conteudo</label>
